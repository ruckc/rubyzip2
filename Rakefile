...
begin
  ...
  Jeweler::Tasks.new do |gem|
    ...
    gem.email = ['me@samlown.com', 'postmodern.mod3@gmail.com','ruckc@yahoo.com']
    gem.homepage = 'http://github.com/ruckc/rubyzip2'
    gem.authors = ['Postmodern', 'Thomas Sondergaard', 'Sam Lown', 'Curtis W. Ruck']
    gem.files =  FileList[
      'README.txt',
      'NEWS.txt',
      'TODO.txt',
